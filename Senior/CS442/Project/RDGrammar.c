...
// <Stmt>    :== <Assign>
{
    ...
    switch (CurrentToken()) {
        ...
        case IDENT_TOK:
            ...
            return LEAVE_SUCC;
        default:
            ParseError("No option in switch - Stmt()");
            return LEAVE_FAIL;
    }
    return LEAVE_SUCC;
}
...
// <Decl>    :== <Type> <IDLst>              INT CHR
{
    ...
    switch (CurrentToken()) {
        ...
        case CHR_TOK:
            ...
            return LEAVE_SUCC;
        default:
            ParseError("No option in switch - Dec()");
            return LEAVE_FAIL;
    }
...
// <Type>    :== CHR
{
    ...
    switch (CurrentToken()) {
        ...
        case CHR_TOK:
            ...
            return LEAVE_SUCC;
        default:
            ParseError("No option in switch - Type()");
            return LEAVE_FAIL;
    }
    return LEAVE_SUCC;
}
...
// <MLst>    :==
{
    ...
    switch (CurrentToken()) {
        ...
        case SEMI_TOK:
            ...
            return LEAVE_SUCC;
        default:
            //ParseError("No option in switch - MList()");
            return LEAVE_SUCC;
    }
...
// <MExpr>		:==
{
    ...
    switch (CurrentToken()) {
        ...
        case RPAREN_TOK:
            return LEAVE_SUCC;
        default:
            //ParseError("No option in switch - MExpr()");
            return LEAVE_SUCC;
    }
}
...
//<MTerm>		:==
{
    ...
    switch (CurrentToken()) {
        ...
        case RPAREN_TOK:
            return LEAVE_SUCC;
        default:
            //ParseError("No option in switch - MTerm()");
            return LEAVE_SUCC;
    }
}
...
// <Factor>	:==	<Ident>
{
    ...
    switch (CurrentToken()) {
        ...
        default:
            ParseError("No option in switch - Factor()");
            return LEAVE_FAIL;
    }
}
...
// <AddOp>		:==	+
{
    ...
    switch (CurrentToken()) {
        ...
        case MINUS_TOK:
            ...
            return LEAVE_SUCC;
        default:
            ParseError("No option in switch - AddOpp()");
            return LEAVE_FAIL;
    }
}
...
// <MultOp>	:==	/
{
    ...
    switch (CurrentToken()) {
        ...
        case DIV_TOK:
            ...
            return LEAVE_SUCC;
        default:
            ParseError("No option in switch - MultOp()");
            return LEAVE_FAIL;
    }
}
